...
var UserSchema = new Schema({
	firstName: {
		...
		trim: true,
		default: '',
		validate: [validateLocalStrategyProperty, 'Please provide your first name']
	},
	lastName: {
		type: String,
		trim: true,
		default: '',
		validate: [validateLocalStrategyProperty, 'Please provide your last name']
	},
	displayName: {
		type: String,
		trim: true
	...
	roles: {
		type: [{
			type: String,
			enum: constants.ROLES_ALL_ROLES
		}]
	},
	updated: {
		type: Date
